...
export const initialFrames: CanvasFrame[] = [
  {
    ...
    width: 1440,
    height: 900,
    chrome: { type: "none", bezelRadius: 10 },
    srcDoc: demoDocument,
    background: "#f3f0e9",
  },
  {
    ...
    width: 820,
    height: 1180,
    chrome: { type: "none", bezelRadius: 18 },
    srcDoc: demoDocument,
    background: "#f3f0e9",
  },
  {
    ...
    width: 390,
    height: 844,
    chrome: { type: "notch", width: 164, height: 30, bezelRadius: 48 },
    srcDoc: demoDocument,
    background: "#f3f0e9",
  },
  {
    ...
    width: 430,
    height: 932,
    chrome: { type: "dynamic-island", width: 136, height: 38, bezelRadius: 56 },
    srcDoc: demoDocument,
    background: "#f3f0e9",
  },
  {
